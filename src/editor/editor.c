...
/*   Updated: 2020/10/20 12:58:07 by tbergkul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	set_text(dm, ft_strfjoin(le->opt[0], ft_itoa(le->options[0])),
		(int[3]){25, 1065, 0xE71313}, 0.8);
	set_text(dm, ft_strfjoin(le->opt[1], ft_itoa(le->options[1])),
		(int[3]){100, 1035, 0xE71313}, 0.8);
	set_text(dm, ft_strfjoin(le->opt[2], ft_itoa(le->options[2])),
		(int[3]){175, 1015, 0xE71313}, 0.8);
	set_text(dm, ft_strfjoin(le->opt[3], ft_itoa(le->options[3])),
		(int[3]){250, 970, 0xE71313}, 0.8);
	set_text(dm, ft_strfjoin(le->opt[4], ft_itoa(le->options[4])),
		(int[3]){325, 1075, 0xE71313}, 0.8);
